...
class _HomeState extends State<Home> {
  ...
  List<String> itemsIcons = [
    ...
    "assets/images/return_box.png",
    "assets/images/report.png"
  ];

  List<String> itemsIcons2 = [
    "assets/images/invoice2.png",
    "assets/images/return_box2.png",
    "assets/images/report.png"
  ];
  List<String> itemsIcons3 = [
    "assets/images/cash.png",
    "assets/images/payment.png",
    "assets/images/report.png"
  ];

  List<String> itemsIcons4 = [
    "assets/images/add_to_basket.png",
    "assets/images/packaging.png"
  ];

  List<String> itemsIcons5 = [
    "assets/images/add_client.png",
    "assets/images/customer_review.png",
    "assets/images/add_supplier.png",
  ];

  @override
  Widget build(BuildContext context) {
    List<String> itemsNames = [
      AppLocalizations.of(context).translate('فاتورة بيع'),
      AppLocalizations.of(context).translate('مرتجع بيع'),
      AppLocalizations.of(context).translate("التقارير")
    ];
    List<String> itemsNames2 = [
      AppLocalizations.of(context).translate("فاتورة شراء"),
      AppLocalizations.of(context).translate("مرتجع شراء"),
      AppLocalizations.of(context).translate("التقارير")
    ];

    List<String> itemsNames3 = [
      AppLocalizations.of(context).translate("تحصيل عميل"),
      AppLocalizations.of(context).translate("دفع مورد"),
      AppLocalizations.of(context).translate("التقارير")
    ];

    List<String> itemsNames4 = [
      AppLocalizations.of(context).translate("اضافة منتج"),
      AppLocalizations.of(context).translate("قائمة المنتجات")
    ];

    List<String> itemsNames5 = [
      AppLocalizations.of(context).translate("اضافة عميل"),
      AppLocalizations.of(context).translate("العملاء"),
      AppLocalizations.of(context).translate("اضافة مورد")
    ];

    String no_wifi = "assets/images/no_wifi.png";
    String yes_wifi = "assets/images/yes_wifi.png";
    String wifi_image = no_wifi;

    String switch_on = "assets/images/switch_on.png";
    String switch_off = "assets/images/switch_off.png";
    String swich = switch_on;

    String syncOn = "assets/images/sync.png";
    String syncOff = "assets/images/sync_off.png";
    String ic_sync = syncOn;
                      ...
                      child: Row(
                        children: [
                          Padding(
                            ...
                            child: Text(
                              AppLocalizations.of(context).translate("الاتصال"),
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Container(
                              color: StyleColors.primeryColor,
                              height: 20,
                              width: 1,
                            ),
                          ),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              AppLocalizations.of(context).translate("الوردية"),
                              style: TextStyle(color: Colors.black),
                            ),
                          ),
                          Image.asset(
              ...
              children: [
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context).translate("المبيعات"),
                          style: TextStyle(
                              color: StyleColors.primeryColor,
                    ...
                    SizedBox(
                      ...
                      child: GridView.count(
                        ...
                        crossAxisCount: itemsNames.length,
                        crossAxisSpacing: 2,
                        mainAxisSpacing: 2,
                        children: List.generate(itemsNames.length, (index) {
                          return GestureDetector(
                            ...
                            child: itemHome(
                                itemsIcons, itemsNames, index, context),
                          );
                        }),
                      ),
                    ),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context).translate("المشتريات"),
                          style: TextStyle(
                              color: StyleColors.primeryColor,
                              fontWeight: FontWeight.bold),
                        )
                    ...
                    SizedBox(
                      ...
                      child: GridView.count(
                        physics: NeverScrollableScrollPhysics(),
                        crossAxisCount: itemsNames2.length,
                        crossAxisSpacing: 10,
                        mainAxisSpacing: 10,
                        children: List.generate(itemsNames2.length, (index) {
                          return GestureDetector(
                            onTap: () {},
                            child: itemHome(
                                itemsIcons2, itemsNames2, index, context),
                          );
                        }),
                      ),
                    ),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context).translate("النقدية"),
                          style: TextStyle(
                              color: StyleColors.primeryColor,
                              fontWeight: FontWeight.bold),
                        )
                    ...
                    SizedBox(
                      ...
                      child: GridView.count(
                        physics: NeverScrollableScrollPhysics(),
                        crossAxisCount: itemsNames3.length,
                        crossAxisSpacing: 10,
                        mainAxisSpacing: 10,
                        children: List.generate(itemsNames3.length, (index) {
                          return GestureDetector(
                            onTap: () {},
                            child: itemHome(
                                itemsIcons3, itemsNames3, index, context),
                          );
                        }),
                      ),
                    ),
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              ...
                              Image.asset("assets/images/money_management.png",
                                  width: 25, height: 25),
                            ],
                          ),
                          Padding(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context).translate("المنتجات"),
                          style: TextStyle(
                              color: StyleColors.primeryColor,
                              fontWeight: FontWeight.bold),
                        )
                    ...
                    SizedBox(
                      ...
                      child: GridView.count(
                        physics: NeverScrollableScrollPhysics(),
                        crossAxisCount: itemsNames4.length,
                        crossAxisSpacing: 10,
                        mainAxisSpacing: 10,
                        children: List.generate(itemsNames4.length, (index) {
                          return GestureDetector(
                            onTap: () {},
                            child: itemHome(
                                itemsIcons4, itemsNames4, index, context),
                          );
                        }),
                      ),
                    ),
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: GridView.count(
                        physics: NeverScrollableScrollPhysics(),
                        crossAxisCount: itemsNames5.length,
                        crossAxisSpacing: 10,
                        mainAxisSpacing: 10,
                        children: List.generate(itemsNames5.length, (index) {
                          return GestureDetector(
                            onTap: () {},
                            child: itemHome(
                                itemsIcons3, itemsNames5, index, context),
                          );
                        }),
                      ),
                    ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context).translate("اخرى"),
                      style: TextStyle(
                          color: StyleColors.primeryColor,
                          fontWeight: FontWeight.bold),
                    )
                ...
                Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        color: StyleColors.primeryColor_trans,
                        boxShadow: [
                          BoxShadow(
                            color: Colors.black12,
                            offset: Offset(1, 2),
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              ...
                              Image.asset("assets/images/express_delivery.png",
                                  width: 25, height: 25),
                            ],
                          ),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              AppLocalizations.of(context).translate('الشحنات'),
                              style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold),
                            ),
...
void showPopupMenu(BuildContext context, Offset tapPosition) async {
  ...
  const double offsetX = 16.0; // Adjust this value to set the desired left offset
  ...
  await showMenu(
    ...
    items: [
      PopupMenuItem(
        child: Text('كل المبيعات'),
        value: 1,
      ),
      PopupMenuItem(
        child: Text('كل مرتجعات'),
        value: 2,
      ),
